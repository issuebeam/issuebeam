...
3. Configure `GITHUB_TOKEN` and `tracker/github_repo` (see GUIDA §2–4).
...
- Use the integrated terminal; `GITHUB_TOKEN` from Windows user variables is picked up after restart.
